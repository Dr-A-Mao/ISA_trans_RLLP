...
%   c    - either an inertial point on stright-line or center
% of the spiral
...
function out = path_manager(in,P)
  ...
  if num_waypoints==0 % start of simulation
      ...
      Va_d   = P.Va_c; % desired airspeed along waypoint path
  ...
  elseif type_dubins == true
    out = path_manager_dubins(in,P,start_of_simulation); 
    start_of_simulation=0;

  else
    out = path_manager_straight_line(in,P,start_of_simulation); 
    start_of_simulation=0;
